...
pub use fs::{
    CertDer, CertSlot, DF_CERT_DIRECTORY_FID, EF_AUTH_CERT_ALT_FID, EF_AUTH_CERT_FID,
    EF_ISSUING_CA_ECC_FID, EF_ROOT_CA_FID, EF_SIGN_CERT_ALT_FID, EF_SIGN_CERT_FID,
    EF_TOKEN_INFO_FID, PKCS15_AID, Pkcs15Error, Pkcs15Ops,
};
