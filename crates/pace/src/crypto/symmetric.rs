...
pub fn aes256_cbc_encrypt_no_padding(
    key: &[u8; AES_KEY_LEN],
    initialization_vector: &[u8; AES_BLOCK],
    plaintext: &[u8],
    ...
    let cipher = Encryptor::new(key.into(), initialization_vector.into());
...
pub fn aes256_cbc_decrypt_no_padding(
    ...
    let cipher = Decryptor::new(key.into(), initialization_vector.into());
